...
public class BackgroundTask extends AsyncTask <String, Void, String> {
        ...
        if (metodo.equals("registro")) {
            ...
            try {
                ...
                String data = URLEncoder.encode("nome", "UTF-8") + "=" + URLEncoder.encode(nome, "UTF-8") + "&" +
                        ...
                        URLEncoder.encode("doador", "UTF-8") + "=" + URLEncoder.encode(doador, "UTF-8");
    ...
    protected void onPostExecute(String result) {
        ...
        else if (result.startsWith("Seja")){
            ctx.startActivity(new Intent(ctx, PesquisaActivity.class));
